...
Mathematical Documentation (Theory)
***********************************

In this Section the **mathematical description** of the model will be
explained. The structure here follows the basic code structure and proceeds as
follows:
...
then concluded by the additional description of various feature modules. 
